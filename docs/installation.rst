...
To install PyAdaptiveCards, run this command in your terminal:

.. code-block:: console

    $ pip install pyadaptivecards

This is the preferred method to install PyAdaptiveCards, as it will always install the most recent stable release.
...
The sources for PyAdaptiveCards can be downloaded from the `Github repo`_.
